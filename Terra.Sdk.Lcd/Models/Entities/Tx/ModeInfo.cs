...
namespace Terra.Sdk.Lcd.Models.Entities.Tx
{
    ...
    public class ModeInfo
    {
        ...
        [ProtoContract]public class SingleMode
        {
            [ProtoMember(1)]public SignMode Mode { get; set; }
            [ProtoMember(2)]public string Signature { get; set; }
        }

        [ProtoContract]public class MultiMode
        {
            [JsonProperty("bitarray")]
            [ProtoMember(1)]public CompactBitArray BitArray { get; set; }

            [JsonProperty("modeInfos")]
            [ProtoMember(2)]public List<ModeInfo> ModeInfos { get; set; }
        }

        [ProtoContract]public enum SignMode
        {
